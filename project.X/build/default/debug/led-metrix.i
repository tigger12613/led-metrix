...
void clear_matrix()
{
  ...
  for (int i = 0; i < (8); i++)
  {
    set_register1(((i) + 1), 0b0000000);
    set_register2(((i) + 1), 0b0000000);
    set_register3(((i) + 1), 0b0000000);
    set_register4(((i) + 1), 0b0000000);
  }
}
...
void init_max7219()
{
  ...
  set_register1((0x0F), (0x0));

  set_register1((0x0A), 0x1);

  set_register1((0X0C), (0x0));

  set_register1((0x0B), 7);

  set_register1((0x09), 0B00000000);

  set_register2((0x0F), (0x0));

  set_register2((0x0A), 0x1);

  set_register2((0X0C), (0x0));

  set_register2((0x0B), 7);

  set_register2((0x09), 0B00000000);

  set_register3((0x0F), (0x0));

  set_register3((0x0A), 0x1);

  set_register3((0X0C), (0x0));

  set_register3((0x0B), 7);

  set_register3((0x09), 0B00000000);

  set_register4((0x0F), (0x0));

  set_register4((0x0A), 0x1);

  set_register4((0X0C), (0x0));

  set_register4((0x0B), 7);

  set_register4((0x09), 0B00000000);
...
void plot(unsigned char pattern[16][16])
{
    ...
    for (i = 0; i < 8; i++)
    {
      ...
      set_register1(((i) + 1), char_pattern1[i]);
      set_register2(((i) + 1), char_pattern2[i]);
      set_register3(((i) + 1), char_pattern3[i]);
      set_register4(((i) + 1), char_pattern4[i]);
    }


    set_register1((0X0C), (0x1));
    set_register2((0X0C), (0x1));
    set_register3((0X0C), (0x1));
    set_register4((0X0C), (0x1));
